...
Widget articleListScreenListItem(BuildContext context, int index) {
  return Padding(
          ...
          children: [
            SizedBox(
              ...
              child: CachedNetworkImage(
                imageUrl: Get.find<ArticleModelController>()
                    .articleList[index]
                    .imagePath,
              ...
              child: Column(
                children: [
                  Text(
                      ...
                      Get.find<ArticleModelController>()
                          .articleList[index]
                          .title),
                  const SizedBox(
                    height: 10,
